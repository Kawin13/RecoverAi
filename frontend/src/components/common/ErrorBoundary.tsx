    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-[400px] flex items-center justify-center p-6">
          <div className="max-w-lg w-full bg-surface border border-border/80 rounded-2xl p-6 shadow-fintech-card space-y-4 text-left">
            ...
            <div className="bg-slate-50 border border-border rounded-xl p-3.5 text-xs text-slate-700 font-mono leading-relaxed break-words">
            ...
            <div className="flex flex-wrap items-center gap-2.5 pt-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-surface hover:bg-slate-50 border border-border text-navy rounded-xl text-xs font-semibold transition-all shadow-2xs cursor-pointer"
              >
            ...
            {this.state.errorInfo && (
              <div className="pt-2 border-t border-border/70">
                <button
                  ...
                  className="inline-flex items-center gap-1 text-[11px] text-slate-500 hover:text-navy font-semibold transition-colors cursor-pointer"
                >
                ...
                {this.state.showDetails && (
                  <div className="mt-2 p-3.5 bg-slate-900 text-slate-200 rounded-xl font-mono text-[10px] max-h-48 overflow-y-auto">
