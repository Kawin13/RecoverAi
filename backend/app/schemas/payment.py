...
class CreateOrderRequest(BaseModel):
    ...
    recovery_case_id: Optional[str] = Field(default=None, description="Optional recovery case ID being paid")
    original_order_id: Optional[str] = Field(default=None, description="Optional original order ID being recovered")
