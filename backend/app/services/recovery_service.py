...
class RecoveryService:
    ...
    def get_recovery_case(self, case_id: str, workspace_id: Optional[str] = None) -> Optional[RecoveryCase]:
        return self.repo.get_by_id(case_id, workspace_id=workspace_id)
    ...
    def get_queue_counts(self, workspace_id: Optional[str] = None) -> Dict[str, int]:
        return self.repo.get_queue_counts(workspace_id=workspace_id)
